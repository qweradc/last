...
// task_finish.sh 文件目录
var taskFile = path.join(rootPath, 'config/task_finish.sh');
// 日志目录
...
var configString = "config sample crontab shareCode diy task bot";
    ...
    try {
        ...
        const response = await got(url, {
            ...
            headers: {
                ...
                'User-Agent': 'jdapp;android;9.3.5;10;8363733393130333235393839383-43D2034346133316639336669356;network/wifi;model/MI 6;addressid/0;aid/6d1bfc43cd2a71f3;oaid/3bdf5cef40db0223;osVer/28;appBuild/88681;partner/xiaomi001;eufv/1;Mozilla/5.0 (Linux; Android 10; MI 6 Build/PKQ1-wesley_iui-19.12.12; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/045131 Mobile Safari/537.36',
        ...
        if (configString.indexOf(request.params.key) > -1) {
            switch (request.params.key) {
                ...
                case 'diy':
                    ...
                    break;
                case 'task':
                    content = getFileContentByName(taskFile);
                    break;
                default:
                    break;
            }
